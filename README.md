...
- [Write documentation like you develop code](https://opensource.com/article/22/10/docs-as-code)
...
- [Trick Lua into becoming an object-oriented language](https://opensource.com/article/22/10/object-oriented-lua)
<!-- BLOG-POST-LIST:END -->
